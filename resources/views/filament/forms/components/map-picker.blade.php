<div class="space-y-3" x-data="mapPicker()" x-init="init()">
    ...
    <div x-show="open" 
        ...
        <div style="position: relative; background-color: #ffffff; border-radius: 1.5rem; width: 100%; max-width: 56rem; height: 85vh; max-height: 700px; display: flex; flex-direction: column; overflow: hidden; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); border: 1px solid #e2e8f0; z-index: 10; box-sizing: border-box;">
