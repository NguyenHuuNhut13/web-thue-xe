        ...
        return $schema
            ->components([
                ...
                TextInput::make('slug')
                    ...
                    ->placeholder('toyota-fortuner-2023'),
                ...
                TextInput::make('model')
                    ->label('Dòng xe')
                    ->placeholder('Ví dụ: Fortuner, Civic')
                    ->required(),
                ...
                TextInput::make('location')
                    ...
                    ->placeholder('Ví dụ: 222 Lê Văn Sỹ, Quận 3, TP.HCM')
                    ->columnSpanFull(),
                ...
                Select::make('status')
                    ...
                    ->options([
                        ...
                        'active' => 'Hiển thị công khai (Active)',
                        'inactive' => 'Tạm ẩn/Khóa xe (Inactive)',
                    ])
                    ->required()
                    ->default('pending'),
            ]);
